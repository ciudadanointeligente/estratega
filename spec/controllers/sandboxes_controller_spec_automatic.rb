...
RSpec.describe SandboxesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all sandboxes as @sandboxes" do
      ...
      expect(assigns(:sandboxes)).to eq([sandbox])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created sandbox" do
        post :create, {:sandbox => valid_attributes}, valid_session
        expect(response).to redirect_to(Sandbox.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved sandbox as @sandbox" do
        post :create, {:sandbox => invalid_attributes}, valid_session
        expect(assigns(:sandbox)).to be_a_new(Sandbox)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested sandbox" do
        sandbox = Sandbox.create! valid_attributes
        put :update, {:id => sandbox.to_param, :sandbox => new_attributes}, valid_session
        sandbox.reload
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the sandboxes list" do
      sandbox = Sandbox.create! valid_attributes
      delete :destroy, {:id => sandbox.to_param}, valid_session
      expect(response).to redirect_to(sandboxes_url)
    end
  end
